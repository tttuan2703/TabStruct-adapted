...
def preprocess_tableqa_function_T0(examples, tokenizer, data_args, padding, table_processor, is_training=False, logger=None):
    ...
    for example_table, query, answers in zip(examples["table"], examples["question"], examples["answers"]):
        ...
        input_ids, attention_mask, token_type = get_token_type_T0(table, query, tokenizer)
...
def get_token_type_T0(table, query, tokenizer):
