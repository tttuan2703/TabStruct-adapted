...
class TabStructEncoder(BartPreTrainedModel):
    """
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        self.layers = nn.ModuleList([TabStructEncoderLayer(config) for _ in range(config.encoder_layers)])
    ...
    def forward(
        ...
        embed_pos = self.embed_positions(input, token_type)
