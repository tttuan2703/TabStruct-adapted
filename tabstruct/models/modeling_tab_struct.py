...
from tabstruct.models.tab_struct_model import TabStructModel


class TabStructForConditionalGeneration(BartPreTrainedModel):
    ...
    def __init__(self, config: BartConfig):
        ...
        self.model = TabStructModel(config)
